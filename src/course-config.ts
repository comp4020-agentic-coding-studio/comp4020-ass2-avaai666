...
export const courseMeta = slopCourseMetaSchema.parse({
  ...
  endDate: "2027-05-28",
  description:
    "A mistranslation is not a failure to be corrected. It is the only " +
    "visible seam in a system that is otherwise invisible. Twelve weeks " +
    "reconstructing the machines that made the errors we read in public.",
  tags: ["translation", "forensics", "evidence"],
